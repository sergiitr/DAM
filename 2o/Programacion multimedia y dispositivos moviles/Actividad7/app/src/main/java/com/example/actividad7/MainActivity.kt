/**
 * MainActivity: Clase principal de la aplicación que gestiona tres botones y muestra mensajes en un TextView según el botón pulsado. Botones:
...
class MainActivity : AppCompatActivity() {
    ...
    fun capturarEvento(view: View) {
        when(view.id){
            R.id.btnSaludar -> txtResultado.text = "¡Hola Sergio Trillo!"
            R.id.btnNoSaludar -> txtResultado.text = "No quiero saludar a nadie..."
